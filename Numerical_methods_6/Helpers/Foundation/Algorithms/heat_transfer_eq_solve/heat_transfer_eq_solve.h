...
void NPDsolve_Newton(const std::string path, int left, int right, size_t NumTime, size_t NumX, size_t NumberOfResult, T LatterTime);
void NPDsolve_NONLinear(const std::string path, bool left_flow, bool right_flow, size_t timestamps, size_t nodes, size_t results, T finish, T sigma, int lim = 3);
